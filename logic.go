...
// SubscribePositions subscribes to an user's potition details.
//
	...
	go func() {
		...
		for {
			...
			case <-t.C:
				...
				u.log.Printf("[%s] Updating %d positions, last updated at @ %d\n", u.UID, len(res.Data.OtherPositionRetList), res.Data.UpdateTimeStamp)
